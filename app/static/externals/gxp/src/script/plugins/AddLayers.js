...
gxp.plugins.AddLayers = Ext.extend(gxp.plugins.Tool, {
     ...
     */
    addActionTip: "Legg til kartlag", //"Add layers",
     ...
     */
    addServerText: "Legg til ny server", //"Add a New Server",

    /** api: config[addButtonText]
     *  ``String``
     *  Text for add layers button (i18n).
     */
    addButtonText: "Legg til kartlag", //"Add layers",
     ...
     */
    availableLayersText: "Tilgjengelige kartlag", //"Available Layers",
     ...
     */
    layerSelectionText: "Vis tilgjengelige data fra:", //"View available data from:",
